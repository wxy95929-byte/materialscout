...
const MOOD_BOARDS: Record<string, MoodBoard> = {
  ...
  "industrial-loft-living": {
    ...
    items: [
      ...
      { id: "2", name: "Distressed Leather", reasoning: "Timeless and durable seating material.", imageUrl: "/images/distressed-leather.png" },
      { id: "3", name: "Concrete Surfaces", reasoning: "Cool grey tones for a modern edge.", imageUrl: "/images/concrete-surfaces.jpeg" },
    ],
  },
  "coastal-dining-room": {
    ...
    items: [
      ...
      { id: "3", name: "Sandy Beige Linen", reasoning: "Neutral backdrop like the shore.", imageUrl: "/images/sandy-beige-linen.png", pinUrl: "https://www.pinterest.com/search/pins/?q=Sandy%20Beige%20Linen%20dinning%20design%20style&rs=typed" },
    ],
  },
  "mid-century-bedroom": {
  ...
  "boho-patio": {
    ...
    items: [
      ...
      { id: "2", name: "Tropical Greenery", reasoning: "Blurring the lines between indoors and out.", imageUrl: "/images/tropical-greenery.jpeg", pinUrl: "https://www.pinterest.com/search/pins/?q=Tropical%20Greenery%20outdoor%20interior%20design%20style&rs=typed" },
      { id: "3", name: "Macrame Textiles", reasoning: "Soft, handcrafted textures.", imageUrl: "/images/macrame-textiles.jpeg", pinUrl: "https://www.pinterest.com/search/pins/?q=Macrame%20Textiles%20outdoor%20interior%20design%20style&rs=typed" },
    ],
  },
};
