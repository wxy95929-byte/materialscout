    ...
    items: [
      {
        ...
        price: "$899.00",
        imageUrl: "https://images.unsplash.com/photo-1615529182904-14819c35db37?auto=format&fit=crop&w=800",
        shoppingUrl: "https://www.google.com/search?q=whitewashed+oak+dining+table&tbm=shop",
      },
      {
        id: "2",
        name: "Woven Seagrass Dining Chairs (Set of 2)",
        reasoning: "Natural texture brings organic warmth to the cool palette",
        price: "$350.00",
        imageUrl: "https://images.unsplash.com/photo-1595515106962-590d98436588?auto=format&fit=crop&w=800",
        shoppingUrl: "https://www.google.com/search?q=seagrass+dining+chairs&tbm=shop",
      },
      {
        id: "3",
      ...
      {
        id: "4",
        name: "Rattan Dome Pendant Light",
      ...
      {
        id: "5",
        name: "Natural Jute Area Rug 6x9",
      ...
      {
        id: "6",
        name: "Abstract Seascape Wall Art",
        reasoning: "Ties the color palette together with visual interest",
        price: "$120.00",
        imageUrl: "https://images.unsplash.com/photo-1580136608079-72029d949ee6?auto=format&fit=crop&w=800",
